...
import {
    ...
    validateMediciActionInstructions,
    validateTransaction,
    validateTransfer,
} from '../core';
 ...
 */
export async function mediciActionIfTokenFeePaid(
    ...
    validateMediciActionInstructions(connection, transaction, medici_program_id, feePayer, cache);
    ...
    key = `mediciAction/lastSignature/${transfer.keys.source.pubkey.toBase58()}`;
